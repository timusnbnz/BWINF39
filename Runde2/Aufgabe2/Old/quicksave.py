...
def main():
    ...
    print(Sp.donaldsListe)
    print()
    print("Gewünschte Sorten ("+str(len(Sp.donaldsWunsch)) + "):"+str(Sp.donaldsWunsch))
    print()
    print("Gefundene Sorten: " + str(len(Sp.donaldsListe)))
    print()
    print(Sp.pairs)
    print()
    print(Sp.possibilitys)
main()
